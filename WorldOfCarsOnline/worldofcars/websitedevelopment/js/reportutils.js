app_url = help_app_url // set in the environment.js
html_environment = help_html_environment // set in the environment.js
...
{
	document.forms["report_form"].action = app_url;
	return true;
}
