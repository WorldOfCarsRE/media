...
var windowManager = function( config ) {
	var This = function() {
		...
		This.logOff = function( page ) {
			...
			This.focusWebsite();
			jQuery.get( logout, false, This.closeGame );
		};

		This.redirectWebsite = function( URI ) {
			if( This._config.windows.website == null || jQuery( This._config.windows.website ).attr( 'closed' ) || !This._config.windows.website.location ) {
